...
function getStyle(obj, prop){
  if(obj.currendStyle){ // ?? currentStyle
    return obj.currendStyle[prop]; // currentStyle
  }else{
...
* 中止方法
    ...
    * Event.prototype.stopMeddiatePropagation() ??? Event.prototype.stopImmediatePropagation()
* 监听方法
