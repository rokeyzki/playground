...
* 样式方法
    * Element.prototype.style.setProprety()
    * Element.prototype.style.removeProprety()
    * getStyle
```
...
* 中止事件
    ...
    * Event.prototype.stopPagation() ？？ Event.prototype.stopPropagation()
    * Event.prototype.stopImmediatePagation() ？？ Event.prototype.stopImmediatePropagation()
* 监听事件
