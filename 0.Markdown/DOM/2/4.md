...
* 遍历方法
    ...
    * document.creareTreeWalker()
* 生成方法
    * document.creareElement()
    * document.creareAttribute()
    * document.creareTextNode()
    * document.creareDocumentFragment()
...
* 属性方法
    ...
    * Element.prototype.getArrribute()
...
function getStyle(obj, prop){
  if(obj.currentStyle){
    ...
    return window.computedStyle(obj, false)[prop]; ?? return window.getComputedStyle(obj, false)[prop];
  }
}
```
